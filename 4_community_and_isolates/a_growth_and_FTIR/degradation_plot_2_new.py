...
ax4.legend(handles=handles, loc='upper left', bbox_to_anchor=(1,1.02), fontsize=12)
...
ax7.text(-0.1, 0.5, 'Amorphous PET', ha='right', va='center', transform = ax7.transAxes, rotation=90, fontsize=16, fontweight='bold')
ax8.text(-0.1, 0.5, 'Weathered PET powder', ha='right', va='center', transform = ax8.transAxes, rotation=90, fontsize=16, fontweight='bold')
ax9.text(-0.1, 0.5, 'PET powder', ha='right', va='center', transform = ax9.transAxes, rotation=90, fontsize=16, fontweight='bold')
